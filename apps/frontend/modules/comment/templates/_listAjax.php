...
<a href="#" onClick="$('#form_comment_<?php echo get_class($object->getRawValue()) ?>_<?php echo $object->getId() ?>').fadeToggle('slow'); return false;"><span class="inline icon-add_comment"></span> <?php echo __('Add comment', array(), 'vjComment') ?></a>
