...
<?php endif; ?>
  <div class="box-content show">
    ...
    <br />
    <div class="close">
      <p><?php echo __('There must be at least the minimum of registered users and location filled so you can confirm the') ?> <?php echo __(sfInflector::humanize(sfInflector::underscore(get_class($object->getRawValue())))) ?>.</p>
      <p><?php echo __('When you confirm an email will be sent to all registered users whith the') ?> <?php echo __(sfInflector::humanize(sfInflector::underscore(get_class($object->getRawValue())))) ?> <?php echo __('information and the register will be closed.') ?></p>
