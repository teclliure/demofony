...
<div class="col1">
    ...
    <p class="author"><?php echo __('by')?> <?php echo link_to($action->getSfGuardUser(),'user/showProfile?username='.$action->getSfGuardUser()->getUsername()) ?></p>
...
<div class="col2">
    ...
    <p class="estat"><strong><?php echo __('Status')?>:</strong> <?php echo $action->getState() ?> <span class="misc misc-<?php if($action->isOpened()): ?>unlock<?php else: ?>lock<?php endif;?> inline"></span></p>
</div>
<div class="col3">
