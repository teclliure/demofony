...
<div class="bar-right">
  ...
  <div class="box has-title entrevistas">
      ...
      <?php if ($virtualMeetings && count($virtualMeetings)): ?>
        ...
        <div class="box-content">
            <div class="img"></div>
            <h1><?php echo __('Ask a question to') ?> <?php echo $virtualMeeting->getsfGuardUser()?></h1>
            ...
            <div class="bottom">
              ...
              <strong><span class="misc misc-<?php if($virtualMeeting->isOpened()): ?>unlock<?php else: ?>lock<?php endif; ?> inline"></span><?php echo __($virtualMeeting->getState()) ?></strong>
              <div class="clear"></div>
            </div>
        </div>
      <?php endforeach ?>
