...
<?php else: ?>
  ...
  <?php if(!$form->getObject()->is_delete): ?>
  ...
  <?php else: ?>
    <?php echo $helper->linkToRestore($form->getObject(), array(  'action' => $conf['restore']['action'],  'params' =>   array(  ),  'class_suffix' => 'restore',  'label' => $conf['restore']['label'],)) ?>
    <?php echo $helper->linkToSaveAndRestore($form->getObject(), array(  'params' =>   array(  ),  'class_suffix' => 'save',  'label' => $conf['save_and_restore']['label'],)) ?>
  <?php endif ?>
