      ...
      <div class="right">
          ...
          <div class="footer">
            <?php if ($sf_user->isAuthenticated() && !$object->hasOpinated($sf_user->getGuardUser())): ?>
              <a href="#" class="opino button1" onClick="$('#opinions_list').load('<?php echo url_for('opinion/opinateLike?id='.$opinion->getId()) ?>'); return false;"><?php echo __('I agree') ?> <?php //echo $object->getSfGuardUser()->getName() ?></a>
            <?php endif; ?>
            <div class="stats">
