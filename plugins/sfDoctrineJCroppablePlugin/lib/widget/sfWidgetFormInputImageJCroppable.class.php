...
class sfWidgetFormInputFileInputImageJCroppable extends sfWidgetFormInputFile
{
  ...
  protected function configure($options = array(), $attributes = array())
  {
    ...
    $this->addOption('template', '<table><tr><td>%file%</td></tr>%preview%</table>%input%<br />%delete% %delete_label%');
  ...
  public function render($name, $value = null, $attributes = array(), $errors = array())
  {
    ...
    if ($this->getOption('preview') && $value) {
      ...
      $preview = '<tr><td>'.__('Selection preview').':
