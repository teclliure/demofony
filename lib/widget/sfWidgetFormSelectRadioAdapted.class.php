 ...
 */
class sfWidgetFormSelectRadioAdapted extends sfWidgetFormChoiceBase
{
  /**
   * Constructor.
   *
  ...
  public function formatter($widget, $inputs)
  {
    ...
    {
      $rows[] = $this->renderContentTag('label', $input['input'].$this->getOption('label_separator').$input['label']);
    }
