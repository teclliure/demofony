 ...
 * @method date                getBornDate()             Returns the current record's "born_date" value
 ...
 * @method sfGuardUserProfile  setBornDate()             Sets the current record's "born_date" value
...
abstract class BasesfGuardUserProfile extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('born_date', 'date', null, array(
             'type' => 'date',
             ));
