 ...
 */
class sfFormLanguageAdapted extends sfForm
{
  protected
    $user = null;
  ...
  {
    $data = array('language' => $request->getParameter('language'),'url'=>$request->getParameter('url'));
  ...
  public function configure()
  {
    ...
    $this->widgetSchema->setDefault('url',$this->getOption('url'));
  }
}
