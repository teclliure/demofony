  ...
  public function setup()
  {
    ...
    $this->validatorSchema->setPostValidator(
      new sfValidatorAnd(array(
        new sfValidatorDoctrineUnique(array('model' => 'OpinionMarkedAsSpam', 'column' => array('user_id'))),
        new sfValidatorDoctrineUnique(array('model' => 'OpinionMarkedAsSpam', 'column' => array('opinion_id'))),
      ))
    );
