...
/**
 * CitizenActionIndex form base class.
 *
 * @method CitizenActionIndex getObject() Returns the current form's model object
 *
 * @package    demofony
 * @subpackage form
 ...
 */
abstract class BaseCitizenActionIndexForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->validatorSchema->setPostValidator(
      new sfValidatorDoctrineUnique(array('model' => 'CitizenActionIndex', 'column' => array('id')))
    );

    $this->widgetSchema->setNameFormat('citizen_action_index[%s]');
