...
/**
 * ProposalIndex form base class.
 *
 * @method ProposalIndex getObject() Returns the current form's model object
 *
 * @package    demofony
 * @subpackage form
 ...
 */
abstract class BaseProposalIndexForm extends BaseFormDoctrine
{
