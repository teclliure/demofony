...
/**
 * GovermentProposalIndex form base class.
 *
 * @method GovermentProposalIndex getObject() Returns the current form's model object
 *
 * @package    demofony
 * @subpackage form
 ...
 */
abstract class BaseGovermentProposalIndexForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->validatorSchema->setPostValidator(
      new sfValidatorDoctrineUnique(array('model' => 'GovermentProposalIndex', 'column' => array('id')))
    );

    $this->widgetSchema->setNameFormat('goverment_proposal_index[%s]');
