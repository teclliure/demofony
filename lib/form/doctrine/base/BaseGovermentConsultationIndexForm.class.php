...
/**
 * GovermentConsultationIndex form base class.
 *
 * @method GovermentConsultationIndex getObject() Returns the current form's model object
 *
 * @package    demofony
 * @subpackage form
 ...
 */
abstract class BaseGovermentConsultationIndexForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->validatorSchema->setPostValidator(
      new sfValidatorDoctrineUnique(array('model' => 'GovermentConsultationIndex', 'column' => array('id')))
    );

    $this->widgetSchema->setNameFormat('goverment_consultation_index[%s]');
  ...
  {
    return 'GovermentConsultationIndex';
  }
