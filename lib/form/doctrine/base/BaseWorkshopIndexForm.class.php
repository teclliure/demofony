...
/**
 * WorkshopIndex form base class.
 *
 * @method WorkshopIndex getObject() Returns the current form's model object
 *
 * @package    demofony
 * @subpackage form
 ...
 */
abstract class BaseWorkshopIndexForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->validatorSchema->setPostValidator(
      new sfValidatorDoctrineUnique(array('model' => 'WorkshopIndex', 'column' => array('id')))
    );

    $this->widgetSchema->setNameFormat('workshop_index[%s]');
