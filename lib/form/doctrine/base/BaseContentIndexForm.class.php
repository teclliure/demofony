...
/**
 * ContentIndex form base class.
 *
 * @method ContentIndex getObject() Returns the current form's model object
 *
 * @package    demofony
 * @subpackage form
 ...
 */
abstract class BaseContentIndexForm extends BaseFormDoctrine
{
