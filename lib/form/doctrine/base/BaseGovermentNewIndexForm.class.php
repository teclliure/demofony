...
/**
 * GovermentNewIndex form base class.
 *
 * @method GovermentNewIndex getObject() Returns the current form's model object
 *
 * @package    demofony
 * @subpackage form
 ...
 */
abstract class BaseGovermentNewIndexForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->validatorSchema->setPostValidator(
      new sfValidatorDoctrineUnique(array('model' => 'GovermentNewIndex', 'column' => array('id')))
    );

    $this->widgetSchema->setNameFormat('goverment_new_index[%s]');
